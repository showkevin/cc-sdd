...
### Prerequisites
- Requirements document must exist: `{{KIRO_DIR}}/specs/$1/requirements.md`
...
Generate analysis in the language specified in spec.json (check `{{KIRO_DIR}}/specs/$1/spec.json` for "language" field):
